class Formulas:
    ...
    def mruv_posicion(self, posicion_inicial, velocidad_inicial, aceleracion, tiempo):
        ...
        """
        posimov = posicion_inicial + (velocidad_inicial*tiempo) + (1/2) * (aceleracion * (tiempo ** 2))
        return posimov
    ...
    def mruv_velocidad(self, velocidad_inicial, aceleracion, tiempo):
        ...
        """
        velfinmov = velocidad_inicial + (aceleracion * tiempo)
        return velfinmov
    ...
    def interes_compuesto(self, capital, tasa, tiempo, n=1):
        ...
        """
        monfin_capcom = capital * ((1 + (tasa / n)) ** (n * tiempo))
        return monfin_capcom
